...
Map<String,String> _vi={
  ...
  "BMRdetail":"(Basal Metabolic Rate) tỷ lệ trao đổi chất cơ bản trong cơ thể con người,cho biết mức năng lượng tối thiểu mà cơ thể cần",
...
Map<String,String> _en={
  ...
  "BMRdetail":"(Basal Metabolic Rate) Basal metabolic rate in a facility can tell the user what minimum level the facility needs to have",
